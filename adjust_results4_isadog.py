...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    dogname_dic=dict()
    #open file 
    with open (dogfile,'r') as in_files:
       # read each line
        read_line=in_files.readline()
        #process each line
        while read_line!='':
           
            newLine=read_line.strip()
            if read_line not in dogname_dic:
                dogname_dic[read_line]=1
            #read next line in file
            read_line=in_files.readline()
            
        for key in results_dic:
            #pet img label is of a dog
            if results_dic[key][0] in dogname_dic:
                ...
                #pet img label is not a dog img
            else:
                # Classifier Label IS image of Dog 
